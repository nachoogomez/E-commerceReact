    ...
    <FooterContainer>
      <FooterText>
        ...
        <p>¡Bienvenidos a nuestra página sobre mates! Somos un emprendimiento apasionado por compartir la cultura argentina y la tradición de tomar mate. Nuestro objetivo es difundir la rica historia y los placeres que ofrece esta deliciosa bebida.</p>
          <FooterLinks>
              <a href="https://www.instagram.com/matespatagonicos/?hl=es" target="_blank"><AiFillInstagram size={30}/></a>
              <a href="https://www.facebook.com/profile.php?id=100068540162492&is_tour_dismissed=true" target="_blank"><AiFillFacebook size={30}/></a>
              <a href="https://github.com/nachoogomez" target="_blank"><AiFillGithub size={30}/></a>
          </FooterLinks>  
